  ...
  void _submit() {
    ...
    if (phone.isEmpty && email.isEmpty && username.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Veuillez fournir au moins un identifiant.', style: AppTextStyles.bodyMedium.copyWith(color: Colors.white)),
    ...
    final isPin = RegExp(r'^\d{4,6}$').hasMatch(password);

    if (!isPin && password.length < 6) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Le mot de passe doit contenir au moins 6 caractères.', style: AppTextStyles.bodyMedium.copyWith(color: Colors.white)),
          backgroundColor: AppColors.error,
          behavior: SnackBarBehavior.floating,
        ),
      );
                  ...
                  children: [
                    ...
                    FadeInUp(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Vous avez déjà un compte ?", style: AppTextStyles.bodyMedium),
